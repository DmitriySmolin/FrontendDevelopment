                ...
                <div className="row justify-content-between">
                    <div className="col-10 mx-auto col-md-4 my-5 mx-5">
                        <div className="information">
                            <h2><i class="fa fa-user-circle" aria-hidden="true"></i> О себе</h2>
                    ...
                    <div className="col-10 mx-auto col-md-5 my-5 mx-5">
                        <div className="education">
                            <h2><i class="fa fa-graduation-cap" aria-hidden="true"></i> Образование</h2>
                    ...
                    <div className="col-10 mx-auto col-md-6 my-5 mx-5">
                        <div className="information">
                            <h2><i class="fa fa-building"></i> Опыт работы</h2>
                        </div>
                    </div>
                </div>
                </div>
